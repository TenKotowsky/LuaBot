...
function TextChannel:ListArchived(private, private_joined)
	return self.client._api:request("GET", (private and (private_joined and endpoints.list_joined_private_archived or endpoints.list_private_archived) or endpoints.list_public_archived).list_active:format(self.id))
end
